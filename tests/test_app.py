...
class AppRouteTests(unittest.TestCase):
    ...
    def test_dashboard_renders_current_user_summary(self):
        ...
        self.assertIn("Recent User Logins", page)
        self.assertIn("Recent Application Logins", page)
        self.assertNotIn("<th>Principal Type</th>", page)
        self.assertIn("Application Name", page)
